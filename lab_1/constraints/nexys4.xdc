...
## !!! NOTE YOU MAY NEED TO RENAME THESE SWITCHES TO MATCH YOUR PROJECT !!!
...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { oflow }]; #IO_L18P_T2_A24_15 Sch=led[0]
